	...
	for projectPath in projsToBuild:
		...
		for conf in configurations:					
			...
			if filename != "Visibility_Buffer":
				...
				command = ["xcodebuild","clean","-quiet","-scheme", filename,"-configuration",conf,"build","-allowProvisioningDeviceRegistration","-allowProvisioningUpdates","CODE_SIGNING_REQUIRED=NO"]
